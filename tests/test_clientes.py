...
def validate_clientes():
    ...
    if not nulos_id.empty:
        ...
        render_troubled_rows(nulos_id[["cliente_id", "razon_social", "fuente"]])
    else:
    ...
    if not non_numeric.empty:
        ...
        render_troubled_rows(non_numeric[["cliente_id", "razon_social"]])
    ...
    if ids_unicos == total_non_null:
        ...
        render_troubled_rows(dupes[["cliente_id", "razon_social"]])
    ...
    if not nulos_rs.empty:
        ...
        render_troubled_rows(nulos_rs[["cliente_id", "razon_social"]])
    else:
    ...
    if not dupes_rs.empty:
        ...
        render_troubled_rows(dupes_rs[["cliente_id", "razon_social", "rut", "fuente"]])
    else:
    ...
    if not nulos_rut.empty:
        ...
        render_troubled_rows(nulos_rut[["cliente_id", "razon_social", "rut"]])
    else:
    ...
    if not nulos_dir.empty:
        ...
        render_troubled_rows(nulos_dir[["cliente_id", "razon_social", "direccion"]])
    else:
    ...
    if not dupes_dir.empty:
        ...
        render_troubled_rows(dupes_dir[["cliente_id", "razon_social", "direccion"]])
    else:
    ...
    if not nulos_reg.empty:
        ...
        render_troubled_rows(nulos_reg[["cliente_id", "razon_social", "region"]])
    else:
    ...
    if not nulos_comuna.empty:
        ...
        render_troubled_rows(nulos_comuna[["cliente_id", "razon_social", "comuna"]])
    else:
