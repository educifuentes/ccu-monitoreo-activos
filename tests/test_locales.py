...
def validate_locales(df):
    ...
    if not nulos_id.empty:
        ...
        render_troubled_rows(nulos_id[['cliente_id', 'razon_social', 'fuente']], gid, nulos_id['row_index'])
    else:
    ...
    if not non_numeric.empty:
        ...
        render_troubled_rows(
            non_numeric[['cliente_id', 'razon_social']], 
            gid, 
    ...
    if ids_unicos == total_non_null:
        ...
        render_troubled_rows(dupes[['cliente_id', 'razon_social']], gid, dupes['row_index'])
    ...
    if not nulos_rs.empty:
        ...
        render_troubled_rows(nulos_rs[['cliente_id', 'razon_social']], gid, nulos_rs['row_index'])
    else:
    ...
    if not dupes_rs.empty:
        ...
        render_troubled_rows(dupes_rs[['cliente_id', 'razon_social', 'rut', 'fuente']], gid, dupes_rs['row_index'])
    else:
    ...
    if not nulos_rut.empty:
        ...
        render_troubled_rows(nulos_rut[['cliente_id', 'razon_social', 'rut']], gid, nulos_rut['row_index'])
    else:
    ...
    if not nulos_dir.empty:
        ...
        render_troubled_rows(nulos_dir[['cliente_id', 'razon_social', 'direccion']], gid, nulos_dir['row_index'])
    else:
    ...
    if not dupes_dir.empty:
        ...
        render_troubled_rows(dupes_dir[['cliente_id', 'razon_social', 'direccion']], gid, dupes_dir['row_index'])
    else:
    ...
    if not nulos_reg.empty:
        ...
        render_troubled_rows(nulos_reg[['cliente_id', 'razon_social', 'region']], gid, nulos_reg['row_index'])
    else:
    ...
    if not nulos_comuna.empty:
        ...
        render_troubled_rows(nulos_comuna[['cliente_id', 'razon_social', 'comuna']], gid, nulos_comuna['row_index'])
    else:
