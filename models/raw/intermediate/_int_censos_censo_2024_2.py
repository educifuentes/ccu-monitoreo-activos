...
def int_censos_censo_2024_2():
    ...
    int_censos_censo_2024_2_df["tiene_schoperas"] = int_censos_censo_2024_2_df["total_schoperas"] > 0
    ...
    int_censos_censo_2024_2_df["salidas_total"] = 0
    for i in range(1, 13):
        ...
        if col_name in int_censos_censo_2024_2_df.columns:
            int_censos_censo_2024_2_df["salidas_total"] += pd.to_numeric(int_censos_censo_2024_2_df[col_name], errors='coerce').fillna(0)
        elif col_name_alt in int_censos_censo_2024_2_df.columns:
            int_censos_censo_2024_2_df["salidas_total"] += pd.to_numeric(int_censos_censo_2024_2_df[col_name_alt], errors='coerce').fillna(0)
